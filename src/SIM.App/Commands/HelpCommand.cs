namespace SIM.Commands
{
  ...
  public class HelpCommand : ICommand
  {
    ...
    public CommandResult Execute()
    {
      ...
      {
        throw new ArgumentException($"Cannot find command '{CommandName}'. Run 'sim info' to get list of all supported commands.");
      }

      return new Success
      {
        Message = "SIM.exe is a command-line version of Sitecore Instance Manager 2.0 (SIM2), read more on https://github.com/sitecore/sitecore-instance-manager. The list of commands see in 'Data' array, the arguments are passed in JSON5 format. For example: C:\\> SIM INFO {'command': \"info\"}",
        Data = App.Verbs
