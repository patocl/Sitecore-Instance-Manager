namespace SIM.UnitTests
{
  ...
  public class App_Tests
  {
    ...
    public void Process_HelpCommand()
    {
      ...
      Assert.AreEqual("SIM.exe is a command-line version of Sitecore Instance Manager 2.0 (SIM2), read more on https://github.com/sitecore/sitecore-instance-manager. The list of commands see in \'Data\' array, the arguments are passed in JSON5 format. For example: C:\\> SIM INFO {\'command\': \"info\"}", result.Message);
